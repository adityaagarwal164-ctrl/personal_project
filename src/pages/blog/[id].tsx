...
export default function BlogPost() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      {/* Header Image */}
      <div className="aspect-[21/9] w-full overflow-hidden bg-slate-900">
        <img 
          src={post.image} 
          alt={post.title}
      ...
      <article className="mx-auto max-w-4xl px-6 py-12">
        <div className="mb-8">
          <Link href="/blog" className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 font-semibold mb-6">
        ...
        <div 
          className="prose prose-lg prose-slate max-w-none prose-headings:font-bold prose-h2:text-3xl prose-h2:mt-12 prose-h2:mb-4 prose-h3:text-2xl prose-h3:mt-8 prose-h3:mb-3 prose-p:mb-4 prose-ul:my-6 prose-li:my-2 prose-strong:text-slate-900"
